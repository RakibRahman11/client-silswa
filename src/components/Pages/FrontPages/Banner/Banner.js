...
const Banner = () => {
    return (
        <div>
            ...
            <div>
                <Grid container sx={{ backgroundColor: '#e74c12', width: '100%', color: 'black', paddingY: 2 }}>
                    <Grid item xs={3} md={3}>
                        <img src={bestInstructor} style={{ width: '10%' }} alt='' />
                        <Typography variant="body1" sx={{ fontWeight: 500 }}>
                            Best Instructor
                        </Typography>
                    </Grid>
                    <Grid item xs={3} md={3}>
                        <img src={presentation} style={{ width: '10%' }} alt='' />
                        <Typography variant="body1" sx={{ fontWeight: 500 }}>
                            Simple Presentation
                        </Typography>
                    </Grid>
                    <Grid item xs={3} md={3}>
                        <img src={quiz} style={{ width: '10%' }} alt='' />
                        <Typography variant="body1" sx={{ fontWeight: 500 }}>
                            Quiz and Tests
                        </Typography>
                    </Grid>
                    <Grid item xs={3} md={3}>
                        <img src={support} style={{ width: '10%' }} alt='' />
                        <Typography variant="body1" sx={{ fontWeight: 500 }}>
                            Mentor Support
                        </Typography>
                    </Grid>
