                                ...
                                user.email ?
                                    <div>
                                        <Link to={`/addToCart/${id}`} style={{ textDecoration: 'none' }}>
                                            <Button variant="contained" sx={{ width: '60%', padding: '10px 5px', fontSize: 14, backgroundColor: '#085078', color: 'white', marginLeft: '20%', marginBottom: 2 }}>Enroll in the course</Button>
                                        </Link>
                                    </div>
                                    :
                                    <div></div>
